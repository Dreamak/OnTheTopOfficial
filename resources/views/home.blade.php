    ...
    <div class="row justify-content-around">
        <div class="col-12 col-md-6 mb-3 mt-3">
            <div class="card border-0 shadow">
                <h2 class="card-header text-center">Règlementation OnTheTop</h2>
                <div class="card-body">
                    <h4>Vie de clan:</h4>
                    <ul>
        ...
        <div class="col-12 col-md-6 mt-3 mb-3">
            <div class="row">
                <div class="col-12 mb-3">
                    <div class="card border-0 shadow">
                        <h2 class="card-header text-center">OnTheTop, C'est quoi</h2>
                        <div class="card-body">
                ...
                <div class="col-12 mt-3">
                    <div class="card border-0 shadow">
                        <h2 class="card-header text-center">Informations de la Guilde</h2>
                        <div class="card-body">
        ...
        <div class="col-12 mt-3">
            <div class="card border-0 shadow">
                <h2 class="card-header text-center">Événements à venir</h2>
                <div class="card-body">
                    <ul>
